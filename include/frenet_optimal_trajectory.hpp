...
vector<FrenetPath> cuda_test(vector<FrenetPath>, Spline2D, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double);
