...
cudaHostAlloc((void**)&h_splineXA, splineParamSize*sizeof(double),cudaHostAllocDefault);
cudaHostAlloc((void**)&h_splineXB, splineParamSize*sizeof(double),cudaHostAllocDefault);
cudaHostAlloc((void**)&h_splineXC, splineParamSize*sizeof(double),cudaHostAllocDefault);
cudaHostAlloc((void**)&h_splineXD, splineParamSize*sizeof(double),cudaHostAllocDefault);
cudaHostAlloc((void**)&h_splineXX, splineParamSize*sizeof(double),cudaHostAllocDefault);
cudaHostAlloc((void**)&h_splineYA, splineParamSize*sizeof(double),cudaHostAllocDefault);
cudaHostAlloc((void**)&h_splineYB, splineParamSize*sizeof(double),cudaHostAllocDefault);
cudaHostAlloc((void**)&h_splineYC, splineParamSize*sizeof(double),cudaHostAllocDefault);
cudaHostAlloc((void**)&h_splineYD, splineParamSize*sizeof(double),cudaHostAllocDefault);
cudaHostAlloc((void**)&h_splineYX, splineParamSize*sizeof(double),cudaHostAllocDefault);
...
calcGlobalPathsKernel<<<10, 128>>>(fpBlackList, fpX, fpY, fpListSize, fpListParamSize, splineParamSize, lastS, splineXA, splineXB, splineXC, splineXD, splineXX, splineXNx, splineYA, splineYB, splineYC, splineYD, splineYX, splineYNx);
...
cudaFreeHost(h_fpY);
cudaFreeHost(h_fpCf);
cudaFreeHost(h_splineXA);
cudaFreeHost(h_splineXB);
cudaFreeHost(h_splineXC);
cudaFreeHost(h_splineXD);
cudaFreeHost(h_splineXX);
cudaFreeHost(h_splineYA);
cudaFreeHost(h_splineYB);
cudaFreeHost(h_splineYC);
cudaFreeHost(h_splineYD);
cudaFreeHost(h_splineYX);
